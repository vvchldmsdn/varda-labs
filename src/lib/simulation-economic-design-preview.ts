...
export function buildSimulationEconomicDesignPreview(query: SimulationPreviewQuery, preview = buildSimulationDesignPreview(query), includeDisplayPaths = false) {
