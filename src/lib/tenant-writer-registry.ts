...
export const TENANT_WRITER_REGISTRY = [
  ...
  {
    id: "expired_simulation_execution_cleanup", classification: "mixed", authorization: "machine_admin",
    entrypoints: ["src/app/api/cron/simulation-executions/route.ts"],
    implementationPaths: ["src/db/queries/simulation-execution-cleanup.ts"],
    targets: [userTarget("simulation_executions", "delete"), userTarget("simulation_execution_chunks", "delete"), adminTarget("simulation_execution_service", "update")],
    transition: { prepare: "dry_run_only", activate: "owner_scoped_delete", freeze: "freeze_until_owner_scoped_delete" },
    canonicalOwnerRolloutScope: "not_applicable", canonicalOwnerHttpInput: "forbidden", legacyOwnerEvidence: "not_applicable",
  },
  {
    id: "session_native_portfolio_ledger", classification: "user_owned", authorization: "server_verified_session",
    entrypoints: ["src/app/api/portfolio/ledger/route.ts"],
    implementationPaths: ["src/db/queries/native-portfolio-ledger.ts"],
    targets: [userTarget("accounts", "insert", "update"), userTarget("assets", "insert", "update"), userTarget("event_ledger_entries", "insert")],
    transition: USER_API_TRANSITION, canonicalOwnerRolloutScope: "in_scope", canonicalOwnerHttpInput: "forbidden", legacyOwnerEvidence: "separate",
  },
  {
    id: "native_portfolio_snapshots", classification: "user_owned", authorization: "server_verified_session",
    entrypoints: ["src/app/api/portfolio/ledger/route.ts"],
    implementationPaths: ["src/db/queries/native-portfolio-snapshots.ts"],
    targets: [userTarget("daily_portfolio_snapshots", "insert")],
    transition: USER_API_TRANSITION, canonicalOwnerRolloutScope: "in_scope", canonicalOwnerHttpInput: "forbidden", legacyOwnerEvidence: "separate",
  },
  {
    id: "machine_native_portfolio_snapshots", classification: "user_owned", authorization: "machine_admin",
    entrypoints: ["src/lib/snapshots/native-daily-job.ts#runNativeDailySnapshotJob"],
    implementationPaths: ["src/db/queries/native-portfolio-snapshots.ts"],
    targets: [userTarget("daily_portfolio_snapshots", "insert")],
    transition: USER_API_TRANSITION, canonicalOwnerRolloutScope: "in_scope", canonicalOwnerHttpInput: "forbidden", legacyOwnerEvidence: "separate",
  },
  {
    id: "session_native_contribution_plans", classification: "user_owned", authorization: "server_verified_session",
    entrypoints: ["src/app/api/native-contribution-plans/route.ts"],
    implementationPaths: ["src/db/queries/native-contribution-plans.ts"],
    targets: [userTarget("native_contribution_plans", "insert", "delete")],
    transition: USER_API_TRANSITION, canonicalOwnerRolloutScope: "not_applicable", canonicalOwnerHttpInput: "forbidden", legacyOwnerEvidence: "not_applicable",
  },
  {
    id: "machine_twelve_data_evidence",
    classification: "admin_system",
    authorization: "machine_admin",
    entrypoints: ["src/lib/market-data/twelve-data-service.ts#drainTwelveDataService"],
    implementationPaths: ["src/lib/market-data/twelve-data-store.ts"],
    targets: [adminTarget("market_provider_observations", "insert", "update", "delete"), adminTarget("market_provider_action_coverage", "insert", "update", "delete"), adminTarget("market_provider_corporate_actions", "insert", "delete")],
  ...
  {
    id: "machine_twelve_data_collection",
    classification: "admin_system",
    authorization: "machine_admin",
    // Unwired server functions, not an enabled HTTP route or permission for session callers.
    entrypoints: [
    ...
    implementationPaths: [
      "src/lib/market-data/twelve-data-budget.ts",
      "src/lib/market-data/collection-queue.ts",
    ],
    targets: [
      adminTarget("market_provider_budgets", "insert", "update"),
      adminTarget("market_provider_reservations", "insert", "delete"),
      adminTarget("market_collection_jobs", "insert", "update", "delete"),
    ],
    transition: SHARED_TRANSITION,
    canonicalOwnerRolloutScope: "not_applicable",
