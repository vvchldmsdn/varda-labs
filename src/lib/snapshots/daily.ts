...
function resolveSnapshotCycle(now = new Date()) {
...
function buildCycleForSnapshotDate(snapshotDate: string, now: Date): InternalCycle {
...
function isUsdListedAsset(asset: Pick<AssetRow, "market" | "currency">) {
