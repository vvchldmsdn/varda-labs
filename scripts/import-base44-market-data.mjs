...
function normalizeAssetPrice(record) {
  return {
    ...
    adjustedCloseSource: optionalString(record.source),
  ...
  await runInBatches(assetPrices, async (assetPrice) => {
    ...
    await sql`
      ...
      values (
        ...
        ${assetPrice.adjustedCloseBasis},
        ${assetPrice.adjustedCloseProvider},
        ${assetPrice.adjustedCloseSource},
        ${assetPrice.base44UpdatedAt ?? assetPrice.base44CreatedAt},
      ...
      on conflict (legacy_base44_id) do update set
        ...
        adjusted_close_basis = excluded.adjusted_close_basis,
        adjusted_close_provider = excluded.adjusted_close_provider,
        adjusted_close_source = excluded.adjusted_close_source,
