...
function expectedTriggers() {
  return [
    catalogTrigger({
      ...
      definition:
        "CREATE CONSTRAINT TRIGGER auth_identities_consumed_pairing_binding_guard AFTER UPDATE ON auth_identities NOT DEFERRABLE INITIALLY IMMEDIATE FOR EACH ROW EXECUTE FUNCTION enforce_identity_pairing_consumed_identity_match()",
    }),
    catalogTrigger({
      table: "identity_pairing_intent_events",
      ...
      functionName: "enforce_identity_pairing_consumed_identity_match",
      definition:
        "CREATE CONSTRAINT TRIGGER id_pair_intent_events_identity_match AFTER INSERT ON identity_pairing_intent_events NOT DEFERRABLE INITIALLY IMMEDIATE FOR EACH ROW EXECUTE FUNCTION enforce_identity_pairing_consumed_identity_match()",
    }),
    catalogTrigger({
      table: "identity_pairing_intent_events",
