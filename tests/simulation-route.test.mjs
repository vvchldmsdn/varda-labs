...
describe("Simulation input readiness route boundary", () => {
  it("keeps the page server-rendered and the database adapter server-only", () => {
    ...
    assert.match(ownerInputQuery, /prepareSimulationResearchPaths/);
    ...
    assert.doesNotMatch(ownerInputQuery, /getActivePortfolioOwnerUserIds/);
    ...
    assert.match(ownerInputQuery, /parametricFactorInput/);
    assert.match(
      ownerParametricFactorQuery,
      /loadSimulationFactorRows/,
    );
    assert.match(
      ownerParametricFactorQuery,
  ...
  it("exposes readiness and fixed research output behind the existing access gate", () => {
    ...
    assert.match(view, /data-owner-candidate-comparison/);
    ...
    assert.match(view, /data-owner-parametric-factor/);
    assert.match(view, /data-owner-parametric-factor-account/);
