...
describe("identity pairing authority Phase 1G1-B1b", () => {
  ...
  it("keeps the contract pure and the registered issuer disconnected from runtime", () => {
    ...
    assert.deepEqual(result.evidence, {
      ...
      issuerMigrationCliEntrypoints: 1,
      ...
      claimPresentationConfiguredState: "disabled",
      ...
      accountAssignmentAuthorityIntact: true,
      accountAssignmentMigrationCliImports: 1,
      accountAssignmentMigrationCliBoundaryIntact: true,
      accountAssignmentRuntimeImports: 0,
