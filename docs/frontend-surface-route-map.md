...
| `/simulation` | Product-facing market-input readiness, ready-only observed-return evidence, and an aligned common-axis cumulative observed-index comparison. Hashes, internal ids, raw prices, and FX values stay outside the UI DTO. |
