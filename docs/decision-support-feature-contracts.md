...
| Actual cash-ledger baseline | all account cash | Blocked while the measured path excludes account cash. It requires authoritative cash balances plus deposit, withdrawal, interest, tax, fee, and cash-return policies rather than the zero-return counterfactual shortcut. |
